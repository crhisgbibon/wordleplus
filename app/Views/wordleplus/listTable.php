    ...
    <thead id="wordTableListHead">
      ...
      <tr>
        <td class="listEnd filterTD">
          <div disabled class="wordFilterBookend" id="dictionaryName" type="text"></div>
          <button id="sortButton" class="wordFilterBookend flex justify-center items-center mx-4 active:scale-95"><img id="ioSort" src="images/crown.svg"></button>
        </td>
